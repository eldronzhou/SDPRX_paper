...
python ~/software/PRScsx/PRScsx.py \
  ...
  --sst_file=../../../../summary_stat/${pops}/Scene1/${pop1}/discover/sim_${i}_PRScs.txt,../../../../summary_stat/${pops}/Scene1/${pop2}/discover/sim_${i}_PRScs.txt \
  --n_gwas=40000,40000 \
  --pop=${pop1},${pop2} \
  --out_dir=./ \
  --out_name=sim_${i} \
...
do
    mkdir -p ${phi}/
    python ~/software/PRScsx/PRScsx.py --ref_dir=../../../../ref/PRS_CSx/ --bim_prefix=../../../../genotype/EUR/test/test_5k --sst_file=../../../../summary_stat/${pops}/Scene1/${pop1}/discover/sim_${i}_PRScs.txt,../../../../summary_stat/${pops}/Scene1/${pop2}/discover/sim_${i}_PRScs.txt --n_gwas=40000,40000 --pop=${pop1},${pop2} --out_dir=${phi}/ --out_name=sim_${i} --phi=${phi} --chrom=${j}
