...
do
    mkdir -p ${phi}/
    python ../../../software/PRScsx/PRScsx.py --ref_dir=/ysm-gpfs/pi/zhao/gz222/UKB_real/ref/PRS_CS/ --bim_prefix=../../../genotype/EAS/Ukb_imp_v2 --sst_file=../../summary_stat/EUR/PRS_cs.txt,../../summary_stat/EAS/PRS_cs.txt --n_gwas=563085,108794 --pop=${pop1},${pop2} --out_dir=${phi}/ --out_name=PRS_cs --phi=${phi} --chrom=${i}
