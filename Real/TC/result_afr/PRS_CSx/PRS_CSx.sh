...
do
    mkdir -p ${phi}/
    python ../../../software/PRScsx/PRScsx.py --ref_dir=/ysm-gpfs/pi/zhao/gz222/UKB_real/ref/PRS_CS/ --bim_prefix=../../../genotype/AFR/Ukb_imp_v2 --sst_file=../../summary_stat/EUR/PRS_cs.txt,../../summary_stat/AFR/PRS_cs.txt --n_gwas=929732,92554 --pop=${pop1},${pop2} --out_dir=${phi}/ --out_name=PRS_cs --phi=${phi} --chrom=${i}
