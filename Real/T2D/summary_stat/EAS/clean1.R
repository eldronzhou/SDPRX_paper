...
system("module unload R; source activate ldsc; ~/software/ldsc/ldsc.py --h2 clean.sumstats.gz --ref-ld-chr /ysm-gpfs/pi/zhao/gz222/prs_comparison/LDSC/eas_ldscores/ --out ./clean_h2 --w-ld-chr /ysm-gpfs/pi/zhao/gz222/prs_comparison/LDSC/eas_ldscores/")
...
# prepare for ldpred2
a = a[a$SNP %in% b$SNP,]
write.table(a[,c(2,1,3,4,5,7,8,9,12)], file="ldpred2.txt", append=F, sep="\t", quote=F, row.names=F, col.names=T)
