...
ref_AFR = "../../../ref/AFR/1000G_phase3_common_norel"

ref_EUR = "/ysm-gpfs/pi/zhao/gz222/1000g_phase3/genotype_1KG_eur_SNPmaf5/hm3/eur_SNPmaf5_nomhc"

ss1 = paste0("../../summary_stat/EUR/XPASS.txt")

ss2 = paste0("../../summary_stat/AFR/XPASS.txt")
...
clp2 = ld_clump(pval2, clump_kb=1000, clump_r2=0.1, clump_p=1e-10,
		                    bfile=ref_AFR, plink_bin="plink")
snps2 = clp2$rsid

fit = XPASS(file_z1=ss1, file_z2=ss2, file_ref1=ref_EUR,
		     file_ref2 = ref_AFR, snps_fe1=snps1, snps_fe2=snps2)
