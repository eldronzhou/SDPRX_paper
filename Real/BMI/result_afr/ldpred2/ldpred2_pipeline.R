...
ss = fread("../../summary_stat/AFR/ldpred2.txt")

obj.bigsnp = snp_attach("../../../ref/AFR/1000G_phase3_common_norel.rds")
...
for (chr in 1:22) {
    ...
    # read corr
    corr0 = readRDS(paste0("../../../ref/AFR/ldpred2/1kg_mh3_ldpred2_chr",chr,".rds"))[ind.chr3, ind.chr3]
